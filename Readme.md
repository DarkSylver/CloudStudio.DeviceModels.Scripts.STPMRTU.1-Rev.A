...
# Parsing + Configuration Script – STPMRTU.1 - Rev. A

This **Parsing + Configuration** script is designed for the **STPMRTU.1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – STPMRTU.1 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **STPMRTU.1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
